...
def get_spark_properties():
    keys = [
        "PROJECT_ID", "BQ_PROJECT", "BQ_DATASET", 
        "RETAILER_API_URL", "RETAILER_GCS_BUCKET",
        "RETAILER_MYSQL_URL", "RETAILER_MYSQL_DRIVER", "RETAILER_MYSQL_USER", "RETAILER_MYSQL_PASSWORD",
        "SUPPLIER_MYSQL_URL", "SUPPLIER_MYSQL_DRIVER", "SUPPLIER_MYSQL_USER", "SUPPLIER_MYSQL_PASSWORD"
    ]
    props = {}
    for key in keys:
        val = os.getenv(key)
